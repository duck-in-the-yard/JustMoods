...
export default function SettingsScreen() {
  ...
  const palette = useMemo(() => {
    if (colorScheme === "dark") {
      return {
        tabsBg: "#0f0f0f",
        tabActiveBg: "#1e1e1e",
        tabInactiveText: "rgba(241,241,241,0.7)",
        cardBg: "#171717",
        cardBorder: "#2a2a2a",
        topHairline: "rgba(255,255,255,0.06)",
        inputBg: "#151515",
        inputBorder: "#2a2a2a",
        placeholder: "rgba(241,241,241,0.6)",
        secondaryBtnBg: "#151515",
        secondaryBtnBorder: "#2a2a2a",
        secondaryBtnText: C.text,
    ...
    return {
      ...
      inputBorder: "#cccccc",
      placeholder: "#777777",
      secondaryBtnBg: "#eef2f7",
      secondaryBtnBorder: "#d9dee6",
      secondaryBtnText: "#333333",
  ...
  const handleExport = async () => {
    try {
      const moodJson = await exportJson();
      const moodData = moodJson ? JSON.parse(moodJson) : {};

      const sleepJson = await AsyncStorage.getItem(SLEEP_STORAGE_KEY);
      ...
      const json = JSON.stringify(combinedExport, null, 2);

      await Clipboard.setStringAsync(json);

      const path = FileSystem.cacheDirectory + "mood-sleep-export.json";
      ...
      if (await Sharing.isAvailableAsync()) {
        await Sharing.shareAsync(path, {
          ...
          dialogTitle: "Export mood and sleep data",
        });
      }

      Alert.alert("Export", "Mood and sleep JSON copied and ready to share.");
    } catch (error) {
  ...
  const handleImport = async () => {
    try {
      ...
      if (
        ...
        await importJson(JSON.stringify(parsed.moodData ?? {}));

        await AsyncStorage.setItem(
          SLEEP_STORAGE_KEY,
          JSON.stringify(parsed.sleepData ?? {})
        );
      } else {
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            await clearAll();
            await AsyncStorage.removeItem(SLEEP_STORAGE_KEY);
          },
        },
      ]
    );
        ...
        <View style={[styles.tabs, { backgroundColor: palette.tabsBg }]}>
          {(["data", "user", "display"] as const).map((tab) => (
            <TouchableOpacity
              ...
              style={[
                styles.tabBtn,
                activeTab === tab && { backgroundColor: palette.tabActiveBg },
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  {
                    color:
                      activeTab === tab ? C.text : palette.tabInactiveText,
                  },
                ]}
              >
          ...
          <>
            ...
            >
              <View
                style={[
                  styles.topHairline,
                  { backgroundColor: palette.topHairline },
                ]}
              />
              ...
              >
                Export your mood and sleep data together as one JSON file.
              </Text>
            ...
            >
              ...
              >
                Paste your JSON here. This supports the new combined mood and sleep export.
              </Text>
              ...
              <TextInput
                ...
                placeholder='{"version":1,"moodData":{},"sleepData":{}}'
            ...
            >
              ...
              >
                Delete all mood and sleep data.
              </Text>

              <TouchableOpacity
                style={[styles.dangerBtn, { backgroundColor: "#e74c3c" }]}
                onPress={handleClear}
              >
